...
<script src="<%=request.getContextPath()%>/bootstrap/bootstrap-dialog/dist/js/bootstrap-dialog.min.js"></script>
...
<link href="<%=request.getContextPath()%>/bootstrap/bootstrap-dialog/dist/css/bootstrap-dialog.min.css" rel="stylesheet"></link>


 
<script src="<%=request.getContextPath()%>/bootstrap/bootstrap-table/dist/bootstrap-table.min.js"></script>
<link href="<%=request.getContextPath()%>/bootstrap/bootstrap-table/dist/bootstrap-table.min.css" rel="stylesheet"></link>
 
 <script src="<%=request.getContextPath() %>/bootstrap/bootstrap-table/dist/locale/bootstrap-table-zh-CN.js"></script>
 
<link href="<%=request.getContextPath()%>/bootstrap/bootstrap-select-1.12.4/dist/css/bootstrap-select.min.css" rel="stylesheet">
<script src="<%=request.getContextPath()%>/bootstrap/bootstrap-select-1.12.4/dist/js/bootstrap-select.min.js"></script>
<script src="<%=request.getContextPath()%>/bootstrap/bootstrap-select-1.12.4/dist/js/i18n/defaults-zh_CN.min.js"></script>
