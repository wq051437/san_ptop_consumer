        ...
        <div class="row clearfix">
            ...
            <center>
                <table  width="600px">
                    <tr>
                        <td><h4>联系人：</h4></td>
                        <td><input name="loanname" id="loannameid" type="text" class="form-control"  placeholder="32位之内"/></td>
                    </tr>
                    <tr>
                        <td><h4>借款标题：</h4></td>
                    ...
                    <tr>
                        <td><h4>意向借款金额：</h4></td>
                        <td><input name="loanmoney" id="loanmoneid" type="text" class="form-control" placeholder="单位/元"/></td>
                    </tr>
                    <tr>
                        <td><h4>借款期限：</h4></td>
                        <td><input name="loanmonth" id="loanmonthid" type="text" class="form-control" placeholder="1-24个月"/></td>
                    </tr>
                    <tr>
                        <td><h4>借款类型：</h4></td>
                        <td>
...
<script type="text/javascript">
    ...
    $("#tj").on("click",function(){
        //联系人验证------------------------------------------------------
        var a=document.getElementById("loannameid");
        a = a.value;
        if(a.length>32){
            alert("联系人长度必须在32位之内！");
            return false;
        ...
        //用意向借款金额验证------------------------------------------------------
        var n=document.getElementById("loanmoneid");
        n = n.value;
        if(n==''){
            alert("借款金额不能为空！");
            return false;
        ...
        //借款期限验证------------------------------------------------------
        var z=document.getElementById("loanmonthid");
        z = z.value;
        if(z==''){
            alert("借款期限不能为空！(1-24个月）");
            return false;
        }
